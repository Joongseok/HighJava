	...
	public void setOption() {
		/*
			...
			- contentType ==> 사용할 컨텐츠 타입 설정
					audio/mp3, audio/mpeg, audio/ogg, audio/was, audio/webm 등등..
					
			- interimResults ==> 중간 결과를 반환할 지 여부를 설정
						true ==> 임시결과는 JSON SpeechRecognitionResults객체의 스트림으로 반환된다.
						false ==> 응답은 최종결괌나 있는 단일 SpeechRecognitionResults 객체로 반환된다.
