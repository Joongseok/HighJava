...
public class ArrayListTest {
	public static void main(String[] args) {
		...
		for (int i = 0; i < strArr.length; i++) {
			System.out.println(i + "번? : "+ strArr[i]);
		}
		System.out.println("----------------------------------------");
