...
public class StudentPieChartFormController {
	...
	// StudentVO 객체의 값을 이용하여 PieChart를 그려주는 메서드
    ...
    @FXML
    void initialize() {
        assert btnClose != null : "fx:id=\"btnClose\" was not injected: check your FXML file 'StudentPieChartForm.fxml'.";
        assert stdPieChart != null : "fx:id=\"stdPieChart\" was not injected: check your FXML file 'StudentPieChartForm.fxml'.";
